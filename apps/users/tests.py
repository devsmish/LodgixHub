...
class UserCoreModelTest(TestCase):
    ...
    def test_create_user_with_email(self):
        ...
        user = User.objects.create_user(
            email="tenant@test.com", password="secure_password_123"
        )
    ...
    def test_create_superuser(self):
        ...
        superuser = User.objects.create_superuser(
            email="admin@test.com", password="admin_password_123"
        )
    ...
    def test_soft_delete_user_behavior(self):
        ...
        user = User.objects.create_user(
            email="deleted_user@test.com", password="password123"
        )
    ...
    def test_all_objects_manager_sees_deleted_users(self):
        ...
        user = User.objects.create_user(
            email="archived@test.com", password="password123"
        )
        user.delete()
    ...
    def test_restore_soft_deleted_user(self):
        ...
        user = User.objects.create_user(
            email="comeback@test.com", password="password123"
        )
        user.delete()
        user.restore()
    ...
    def test_blocked_reason_enum_values(self):
        ...
        user = User.objects.create_user(
            email="bad_user@test.com", password="password123"
        )
        ...
        self.assertEqual(
            refreshed_user.get_blocked_reason_display(), "Spam and advertising"
        )
