from apps.bookings.guards.availability_guard import get_available_listing_ids, get_listing_calendar
from apps.bookings.guards.listing_guard import listing_has_active_bookings, room_has_active_bookings
