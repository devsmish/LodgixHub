        ...
        for method_name, operation in methods.items():
            ...
            if operation_id in operation_permissions:
                ...
                for perm in operation_permissions[operation_id]:
                    perm_name = perm.__name__ if hasattr(perm, '__name__') else perm.__class__.__name__

                    if perm_name == 'IsTenant':
                        extra_notes.append("🛑 **Access Restriction:** Allowed only for users in the **Tenant** group.")
                ...
                if extra_notes:
                    ...
                    new_desc = current_desc + "\n\n" + "\n".join(extra_notes) if current_desc else "\n".join(
                        extra_notes)
